...
HD_PWD='E:/Vivado/Work/Student Name Display System/Student Name Display System.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_name_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_name_display.tcl
