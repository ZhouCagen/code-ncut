...
REM
REM Generated by Vivado on Wed Sep 03 09:14:57 +0800 2025
...
echo "xvlog --incr --relax -prj top_student_name_tb_vlog.prj"
call xvlog  --incr --relax -prj top_student_name_tb_vlog.prj -log xvlog.log
