...
REM
REM Generated by Vivado on Fri Sep 19 15:52:36 +0800 2025
...
echo "xvlog --incr --relax -prj gray3_encoder_tb_vlog.prj"
call xvlog  --incr --relax -prj gray3_encoder_tb_vlog.prj -log xvlog.log
