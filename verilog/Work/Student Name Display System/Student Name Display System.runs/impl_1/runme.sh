...
HD_PWD='E:/Vivado/Work/Student Name Display System/Student Name Display System.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_name_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_name_display.tcl -notrace
